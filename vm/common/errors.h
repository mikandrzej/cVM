...
#define VM_ERR_STACK_OVERFLOW VM_ERR_BUILDER(0x08)
#define VM_ERR_HEAP_OVERFLOW VM_ERR_BUILDER(0x09)
#define VM_ERR_APP_END VM_ERR_BUILDER(0x0A)
#define VM_ERR_UNKNOWN VM_ERR_BUILDER(0xFF)
